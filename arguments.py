# Functions in python can have parameters which can be used inside the body of the function.
def print_the_thing(thing):
    print(thing)

# If a function has parameters, you can pass arguments into it.
print_the_thing('a thing')


# A parameter with * in front of it tells Python to accept a tuple of arguments
